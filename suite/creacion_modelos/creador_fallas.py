...
Mw_arbol      = np.linspace(9.4,9.6,3)    # magnitud en Ms del sismo de franchesca
LN_arbol      = np.linspace(-37.0,-37.0,1)  # Limite norte
LS_arbol      = np.linspace(-45.0,-45.0,1) # Limite sur
sflats_arbol  = np.array([80.])  # cantidad de subfallas en latitud para setear razon de aspecto 
